...
export default function CandidateInsightsPage({
  ...
  async function handleRunPublicationAnalysis() {
    ...
    try {
      ...
      setPubStatus(error.message || 'Publication analysis failed.');
    } finally {
      setPubLoading(false);
    }
  }
          ...
          {selectedCandidate && !detailLoading && (
            <div className="page-grid">
              ...
              <section className="info-box">
                ...
                <p>
                  <strong>Detected Universities:</strong> {selectedCandidate.universities || 'None detected'}
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 10 }}>
                  ...
                  <div style={{ display: 'flex', gap: 8, alignItems: 'center', flexWrap: 'wrap' }}>
                    ...
                    <button
                      ...
                      disabled={pubLoading}
                    >
                      {pubLoading ? 'Analysing Publications...' : pubAnalysis ? 'Re-run Publication Analysis' : 'Run Deep Publication Analysis'}
                    </button>
                  </div>
                </div>
